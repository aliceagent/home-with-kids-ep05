...
/* AGENT-DONE(T3): /train hub lists all six modes with icons, one-line blurbs, and per-mode best/attempts (flashcards shows SRS due count). Cover cards are Training / Exit quiz / Study guide. */
